...
import HandelsokonomLoenPage from "./pages/HandelsokonomLoenPage";
...
import SkolelederLoenPage from "./pages/SkolelederLoenPage";
import SalgskonsulentLoenPage from "./pages/SalgskonsulentLoenPage";
import OmdelerLoenPage from "./pages/OmdelerLoenPage";
import KranfoererLoenPage from "./pages/KranfoererLoenPage";
import IndustrioperatoerLoenPage from "./pages/IndustrioperatoerLoenPage";
import FlymekanikerLoenPage from "./pages/FlymekanikerLoenPage";
import AdvokatfuldmaegtigLoenPage from "./pages/AdvokatfuldmaegtigLoenPage";
import VelkommenAffiliateLandingPage from "./pages/VelkommenAffiliateLandingPage";
      ...
      <TooltipProvider>
        ...
        <BrowserRouter>
          <Routes>
            ...
            <Route path="/jobs/kranfoerer" element={<KranfoererLoenPage />} />
            <Route path="/jobs/industrioperatoer" element={<IndustrioperatoerLoenPage />} />
            ...
            <Route path="/jobs/salgskonsulent" element={<SalgskonsulentLoenPage />} />
            <Route path="/jobs/omdeler" element={<OmdelerLoenPage />} />
            ...
            <Route path="/jobs/flymekaniker" element={<FlymekanikerLoenPage />} />
            ...
            <Route path="/jobs/handelsokonom" element={<HandelsokonomLoenPage />} />
            ...
            <Route path="/jobs/skoleleder" element={<SkolelederLoenPage />} />
            <Route path="/jobs/advokatfuldmaegtig" element={<AdvokatfuldmaegtigLoenPage />} />
            <Route path="/velkommen" element={<VelkommenAffiliateLandingPage />} />
