          ...
          <div className="bg-white rounded-lg shadow-lg p-6 md:p-8 prose max-w-none">
            ...
            <section className="mx-auto my-8 max-w-lg rounded-2xl bg-blue-50 p-6 shadow-lg">
              ...
              <p className="mt-4 text-lg leading-7 text-blue-900 text-center">
                Som <strong>politibetjent</strong> kan dine arbejdstimer svinge fra uge til uge.
                Meld dig ind i <strong>Min A-kasse</strong> i dag og få op til
                <strong> 21.092 kr./md (2025)</strong> i dagpenge, hvis du en dag står uden job.
              </p>
