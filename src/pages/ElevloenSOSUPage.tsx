          ...
          <div className="bg-white rounded-lg shadow-lg p-6 md:p-8 prose max-w-none">
            ...
            <section className="mx-auto my-8 max-w-lg rounded-2xl bg-emerald-50 p-6 shadow-lg">
              ...
              <p className="mt-4 text-base leading-6 text-emerald-900 text-center">
                Som <strong>SOSU-elev</strong> kan din praktikplads blive inddraget fra den ene dag til den anden.
                Meld dig ind i <strong>Min A-kasse</strong> helt gratis, mens du studerer - og få op til <strong>17.295 kr./md i dagpenge</strong> som nyuddannet!
              </p>
