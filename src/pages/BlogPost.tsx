...
const BlogPost = () => {
  ...
  return (
    <>
      <SEO 
        title={`5 tips til at optimere din privatøkonomi | Beregn Løn Efter Skat`}
        description="Få 5 effektive tips til at optimere din løn efter skat. Lær at udnytte fradrag, forstå nettoløn vs. bruttoløn og skab et stærkere økonomisk fundament. Beregn din aktuelle løn efter skat i 2025 her!"
      />
      <Header />
