...
export const Header = () => {
  ...
  const jobCategories = {
    ...
    "Sundhed & Omsorg": [
      ...
      { name: "Kiropraktor", path: "/jobs/kiropraktor" },
      { name: "Optiker", path: "/jobs/optiker" },
    ...
    "Undervisning": [
      ...
      { name: "Skoleleder", path: "/jobs/skoleleder" },
    ],
    "Sikkerhed & Forsvar": [
    ...
    "Handel & Service": [
      ...
      { name: "Advokatfuldmægtig", path: "/jobs/advokatfuldmaegtig" },
      ...
      { name: "Au Pair", path: "/jobs/au-pair" },
      { name: "Automationsteknolog", path: "/jobs/automationsteknolog" },
      { name: "Bankrådgiver", path: "/jobs/bankraadgiver-loen-efter-skat" },
      { name: "Bartender", path: "/jobs/bartender" },
      { name: "Bedemand", path: "/jobs/bedemand" },
      { name: "Bilsælger", path: "/jobs/bilsaelger" },
      ...
      { name: "Butiksassistent Ufaglært", path: "/jobs/butiksassistent-ufaglaert" },
      ...
      { name: "Diplomingeniør", path: "/jobs/diplomingenioer" },
      { name: "DJ", path: "/jobs/dj" },
      { name: "Ejendomsadministrator", path: "/jobs/ejendomsadministrator" },
      { name: "Ejendomsservicetekniker", path: "/jobs/ejendomsservicetekniker" },
      ...
      { name: "Flymekaniker", path: "/jobs/flymekaniker" },
      ...
      { name: "Omdeler", path: "/jobs/omdeler" },
      ...
      { name: "Teknisk Designer", path: "/jobs/teknisk-designer" },
      { name: "Tjener", path: "/jobs/tjener" },
      { name: "Togfører", path: "/jobs/togfoerer" },
      { name: "Trafikleder", path: "/jobs/trafikleder" },
      { name: "Tømrer", path: "/jobs/toemrer-loen-efter-skat" },
      { name: "Ungarbejder", path: "/jobs/ungarbejder" },
      { name: "Vikar", path: "/jobs/vikar" },
